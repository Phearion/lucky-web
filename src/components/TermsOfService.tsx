                    ...
                    <div className="space-y-8 text-gray-200">
                        <section className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <p>
                                    🇫🇷 Lucky-chan est un bot Discord gratuit développé par Phearion
                                    Network pour faciliter l'accès aux ressources étudiantes
                                    partagées.
                                </p>
                                <p>
                                    🇬🇧 Lucky-chan is a free Discord bot developed by Phearion
                                    Network to facilitate access to shared student resources.
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-xl font-bold text-purple-300">
                                2. Contributions & Soutien / Support
                            </h2>
                            <div className="space-y-2">
                                <p>
                                    🇫🇷 Nous n'avons pas de microtransactions. Le service est
                                    entièrement gratuit. Les dons via PayPal sont possibles pour
                                    soutenir le projet.
                                </p>
                                <p>
                                    🇬🇧 We have no microtransactions. The service is completely free.
                                    Donations via PayPal are possible to support the project.
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <p>
                                    🇫🇷 Les ressources proviennent d'étudiants volontaires. Vous
                                    devez :
                                </p>
                                <ul className="list-disc space-y-1 pl-6">
                                    ...
                                    <li>
                                        Utiliser les ressources pour votre apprentissage personnel
                                    </li>
                                </ul>

                                <p className="mt-4">
                                    🇬🇧 Resources come from volunteer students. You must:
                                </p>
                                <ul className="list-disc space-y-1 pl-6">
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <p>
                                    🇫🇷 Une vérification annuelle est requise pour accéder aux
                                    ressources. Cela nous permet de maintenir la sécurité du
                                    service.
                                </p>
                                <p>
                                    🇬🇧 Annual verification is required to access resources. This
                                    allows us to maintain service security.
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-xl font-bold text-purple-300">
                                5. Responsabilités / Responsibilities
                            </h2>
                            <div className="space-y-2">
                                <p>🇫🇷 En utilisant Lucky-chan, vous acceptez de :</p>
                                <ul className="list-disc space-y-1 pl-6">
                                    <li>
                                        Ne pas tenter d'accéder aux ressources sans autorisation
                                    </li>
                                    <li>Ne pas utiliser le service de manière abusive</li>
                                    <li>Signaler tout contenu inapproprié</li>
                                    <li>
                                        Accepter que nous pouvons modifier les Conditions
                                        d'Utilisation et la Politique de Confidentialité à tout
                                        moment
                                    </li>
                                </ul>
                                ...
                                <ul className="list-disc space-y-1 pl-6">
                                    ...
                                    <li>
                                        Accept that we may modify the Terms of Service and Privacy
                                        Policy at any time
                                    </li>
                                </ul>
                            </div>
