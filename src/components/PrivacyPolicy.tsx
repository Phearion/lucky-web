                ...
                <div className="relative mx-auto max-w-3xl rounded-2xl border border-purple-500/20 bg-gray-800/40 p-8 backdrop-blur-xl">
                    ...
                    <div className="space-y-8 text-gray-200">
                        <section className="space-y-4">
                            <p className="text-lg">
                                🇫🇷 Lucky-chan, développé par Phearion Network, s'engage à protéger
                                votre vie privée et vos données personnelles conformément au
                                Règlement Général sur la Protection des Données (RGPD).
                            </p>
                            <p className="text-lg">
                                🇬🇧 Lucky-chan, developed by Phearion Network, is committed to
                                protecting your privacy and personal data in compliance with the
                        ...
                        <section className="space-y-4">
                            <h2 className="text-xl font-bold text-purple-300">
                                Base Légale / Legal Basis (RGPD/GDPR)
                            </h2>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <p>
                                    🇫🇷 Les adresses e-mail sont automatiquement supprimées chaque
                                    année, conformément au principe de minimisation des données du
                                    RGPD. Une nouvelle vérification sera nécessaire pour continuer à
                                    utiliser les ressources.
                                </p>
                                <p>
                                    🇬🇧 Email addresses are automatically deleted every year, in
                                    compliance with the GDPR data minimization principle. A new
                                    verification will be required to continue using the resources.
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <p>
                                    🇫🇷 Les ressources disponibles sont partagées volontairement par
                                    d'autres étudiants. Nous vérifions qu'aucune information
                                    sensible ou donnée personnelle n'est présente dans ces
                                    documents, conformément au RGPD.
                                </p>
                                <p>
                                    🇬🇧 Available resources are voluntarily shared by other students.
                                    We verify that no sensitive information or personal data is
                                    present in these documents, in compliance with GDPR.
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <p>
                                    🇫🇷 Vos données sont stockées de manière sécurisée dans l'UE et
                                    ne sont jamais partagées avec des tiers. Nous mettons en œuvre
                                    des mesures techniques et organisationnelles appropriées pour
                                    protéger vos données.
                                </p>
                                <p>
                                    🇬🇧 Your data is stored securely in the EU and is never shared
                                    with third parties. We implement appropriate technical and
                        ...
                        <section className="space-y-4">
                            ...
                            <div className="space-y-2">
                                <p>
                                    🇫🇷 Pour toute question concernant vos données ou pour exercer
                                    vos droits RGPD :
                                </p>
                                <p>
                                    🇬🇧 For any questions about your data or to exercise your GDPR
                                    rights:
                                </p>
                                <p>
                                    <a
